...
XBram_Config XBram_ConfigTable[] =
{
	...
	{
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_DEVICE_ID,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_DATA_WIDTH,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_ECC,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_FAULT_INJECT,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_CE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_CE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_UE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_UE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_ECC_STATUS_REGISTERS,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_CE_COUNTER_WIDTH,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_ECC_ONOFF_REGISTER,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_ECC_ONOFF_RESET_VALUE,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_WRITE_ACCESS,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_BASEADDR,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_HIGHADDR,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_S_AXI_CTRL_BASEADDR,
		XPAR_MICROBLAZE_0_D_BRAM_CTRL_2_S_AXI_CTRL_HIGHADDR
	},
	{
	...
	{
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_DEVICE_ID,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_DATA_WIDTH,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_ECC,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_FAULT_INJECT,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_CE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_CE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_UE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_UE_FAILING_REGISTERS,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_ECC_STATUS_REGISTERS,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_CE_COUNTER_WIDTH,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_ECC_ONOFF_REGISTER,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_ECC_ONOFF_RESET_VALUE,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_WRITE_ACCESS,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_BASEADDR,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_HIGHADDR,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_S_AXI_CTRL_BASEADDR,
		XPAR_MICROBLAZE_0_I_BRAM_CTRL_2_S_AXI_CTRL_HIGHADDR
	}
};
